    ...
    <jsp:body>
        <div class="breadbox">
            <ul class="breadcrumb">
                ...
                <li><a href="role?cn=${param.cn}"><c:out value="${title}"/></a></li>
                <li><a href="role-histories?cn=${param.cn}">History</a></li>
                <li><fmt:formatDate pattern="yyyy-MMM-dd" value="${versionDate}"/></li>
            </ul>
        </div>        
        <section>
            <c:choose>
