 ...
 * @author ryans
 */
@WebServlet(name = "RemoveUserFromGroup", urlPatterns = {"/ajax/remove-user-from-group"})
public class RemoveUserFromGroup extends HttpServlet {

    private static final Logger logger = Logger.getLogger(
            RemoveUserFromGroup.class.getName());    
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            groupFacade.removeUserFromGroup(groupId, staffId);
        } catch(EJBAccessException e) {
            logger.log(Level.WARNING, "Not authorized", e);
            errorReason = "Not authorized";             
        } catch (Exception e) {
            logger.log(Level.SEVERE, "Unable to remove user", e);
