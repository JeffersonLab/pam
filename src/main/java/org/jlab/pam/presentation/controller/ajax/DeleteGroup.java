 ...
 * @author ryans
 */
@WebServlet(name = "DeleteGroup", urlPatterns = {"/ajax/delete-group"})
public class DeleteGroup extends HttpServlet {

    private static final Logger logger = Logger.getLogger(
            DeleteGroup.class.getName());    
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Unable to delete group", e);
            ...
            if (rootCause instanceof SQLException) {
                ...
                if (dbException.getErrorCode() == 2292) {    
                    errorReason = "Group cannot be deleted because it is in use";
                }
            }        
        }
